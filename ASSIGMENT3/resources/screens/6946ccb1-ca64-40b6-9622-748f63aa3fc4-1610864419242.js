jQuery("#simulation")
  .on("click", ".s-6946ccb1-ca64-40b6-9622-748f63aa3fc4 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-6946ccb1-ca64-40b6-9622-748f63aa3fc4 #s-Button_1": {
                      "attributes": {
                    ...
                    "#s-6946ccb1-ca64-40b6-9622-748f63aa3fc4 #s-Button_1 > .backgroundLayer > .colorLayer": {
                      "attributes": {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/e6c8d899-5508-4859-a003-f77f5c9a11e1",
                    "transition": {
                      "type": "fade",
                      "duration": 700
                    }
  ...
  .on("click", ".s-6946ccb1-ca64-40b6-9622-748f63aa3fc4 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
